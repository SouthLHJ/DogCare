...
router.post("/edit",async(req,res)=>{
    try{
        const edit = await Walk.findByIdAndUpdate(req.body.id,{date: req.body.date, time1: req.body.time1, time2 : req.body.time2 , memo: req.body.memo, image: req.body?.image });
